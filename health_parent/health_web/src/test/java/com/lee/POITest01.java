...
public class POITest01 {
    public static void main(String[] args) {
        ...
        try {
            ...
            //创建要设置图片的excel文件
            File file = new File("D:\\钢筋(连接及安装)检验批质量验收记录表(Ⅱ).xlsx");
            //创建一个文件输入流，以防覆盖原本的文件
    ...
    //插入某个图片到指定索引的位置
    private static void insertImage(HSSFWorkbook wb, HSSFPatriarch pa, byte[] data,
